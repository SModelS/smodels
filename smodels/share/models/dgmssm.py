...
#Gluino:
gluino1 = Particle(isSM=False, label='gluino1', pdg=1000021, eCharge=0, colordim=8, spin=1./2,isSelfConjugate=True)
gluino2 = Particle(isSM=False, label='gluino2', pdg=2000021, eCharge=0, colordim=8, spin=1./2,isSelfConjugate=True)
...
n5 = Particle(isSM=False, label='N5', pdg=1000045, eCharge=0, colordim=1, spin=1./2,isSelfConjugate=True)
n6 = Particle(isSM=False, label='N6', pdg=1000055, eCharge=0, colordim=1, spin=1./2,isSelfConjugate=True)
...
#Gravitino
gravitino = Particle(isSM=False, label='G', pdg=1000039, eCharge=1, colordim=1, spin=1./2,isSelfConjugate=True)
...
H2 = Particle(isSM=False, label='H2', pdg=35, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)
H3 = Particle(isSM=False, label='H3', pdg=45, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)
H4 = Particle(isSM=False, label='H4', pdg=55, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)
A1 = Particle(isSM=False, label='A1', pdg=36, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)
A2 = Particle(isSM=False, label='A2', pdg=46, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)
A3 = Particle(isSM=False, label='A3', pdg=56, eCharge=0, colordim=1, spin=0, _isInvisible=False,isSelfConjugate=True)

#Sgluons
sgluon1 = Particle(isSM=False, label='sgluon1', pdg=3000021, eCharge=0, colordim=8, spin=1./2,isSelfConjugate=True)
sgluon1 = Particle(isSM=False, label='sgluon2', pdg=3000022, eCharge=0, colordim=8, spin=1./2,isSelfConjugate=True)
