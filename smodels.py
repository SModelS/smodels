...
def main():
    ...
    xseccomputer.add_argument('-e', '--nevents', type=int, default=100, help="number of events to be simulated.")
    xseccomputer.add_argument('-f', '--tofile', action='store_true', help="write cross sections to file")
