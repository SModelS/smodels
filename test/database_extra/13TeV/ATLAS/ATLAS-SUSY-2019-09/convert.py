...
TChiWZ_plus_on.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2019-09/figaux_06a.png"
)
...
TChiWZ_plus_on.setSources(
    dataLabels=["expExclusion", "obsExclusion", "upperLimits", "expectedUpperLimits"],
    units=[None, None, "pb", "pb"],
    dataFiles=[
        "orig/Fig16aWZExclusion:Wino-bino(+),onshell_Exp.csv",
        "orig/Fig16aWZExclusion:Wino-bino(+),onshell_Obs.csv",
        "orig/newAuxFig8aWZExcl.UpperLimitObs.Wino-bino(+)(Deltam).csv",
        "orig/newAuxFig8bWZExcl.UpperLimitExp.Wino-bino(+)(Deltam).csv",
    ],
...
TChiWZ_plus_on.setSources(
    ...
    units=[None, None, "pb", "pb"],
    dataFiles=[
        "orig/newFig16aWZExclusion:Wino-bino(+),onshell_Exp.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),onshell_Obs.csv",
        "orig/AuxFig8aWZExcl.UpperLimitObs.Wino-bino(+)(Deltam).csv",
        "orig/AuxFig8bWZExcl.UpperLimitExp.Wino-bino(+)(Deltam).csv",
    ],
    dataFormats=["csv", "csv", "csv", "csv"],
)
...
TChiWZ_plus_off.setSources(
    ...
    units=[None, None, None, None, None, None, "pb", "pb"],
    dataFiles=[
        "orig/newFig16aWZExclusion:Wino-bino(+),Exp.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),Exp_Down.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),Exp_Up.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),Obs.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),Obs_Down.csv",
        "orig/newFig16aWZExclusion:Wino-bino(+),Obs_Up.csv",
        "orig/AuxFig8cWZExcl.UpperLimitObs.Wino-bino(+)(Deltam).csv",
        "orig/AuxFig8dWZExcl.UpperLimitExp.Wino-bino(+)(Deltam).csv",
    ],
    dataFormats=["csv", "csv", "csv", "csv", "csv", "csv", "csv", "csv"],
)
...
TChiWZ_higgsino.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2019-09/figaux_06c.png"
)
...
TChiWH.exclusionDataUrl = (
    "https://www.hepdata.net/record/ins1866951?table=Fig%2017%20Wh%20Exclusion,%20Obs"
)
TChiWH.setSources(
    dataLabels=[
        "expExclusion",
    ...
    dataFiles=[
        ...
        "orig/AuxFig9aWhExcl.UpperLimitObs..csv",
        "orig/AuxFig9bWhExcl.UpperLimitExp..csv",
    ],
    dataFormats=["csv", "csv", "csv", "csv", "csv", "csv", "csv", "csv"],
)
