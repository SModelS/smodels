...
for SR in ['SRA250','SRA350','SRA450','SRB']:
    ACC = 'Acc_Percentage_'+SR+".dat"
    EFF = 'Eff_Percentage_'+SR+".dat"
    Map_Multiplier('T2bb',SR,ACC,EFF,3,3,10000)

X,Y = Reading_Values("Obs_Line.dat",2,2)
Simple_Exclusion_Producer(X,Y,"Obs_Excl","T2bb_Obs_Excl.dat")
X,Y = Reading_Values("Exp_Line.dat",2,2)
Simple_Exclusion_Producer(X,Y,"Exp_Excl","T2bb_Exp_Excl.dat")
X,Y,Z = Reading_Values("Obs_UL.dat",3,3)
Simple_Map_Producer(X,Y,Z,"Obs_UL","T2bb_Obs_UL.dat")
