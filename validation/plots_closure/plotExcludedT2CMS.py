...
exp_limit = TH2F("","",31,225.,1000.,20,0.,500.)
...
#Legend
leg = TLegend(0.4899497,0.7601547,0.798995,0.9748549)
...
if metadata['title']:
  ...
  tit = TPaveLabel(0.01005025,0.8317215,0.3266332,0.9825919,title,"brNDC")
  tit.SetBorderSize(4)
  tit.SetFillColor(0)
  tit.SetTextFont(42)
