...
third = [1000005,2000005,1000006,2000006,-1000005,-2000005,-1000006,-2000006]
gluino = [1000021,-1000021]

def getKfactorsFor(pIDs,slhafile,basedir="./nllfast"):
    """Reads the NLLfast grid and returns the k-factors (NLO and NLL) for the production of a pID pair.
...
#stop-stop or sbottom-sbottom = st 
    if pids[0] in gluinos and pids[1] in gluinos: process = "gg"
    elif pids[0] in squarks and pids[1] in squarks: process = "ss"
    elif pids[0] in antisquarks and pids[1] in squarks: process = "sb"
    ????????
    ...
    if pIDm == [1000021,1000021]: process = "gg"
    elif 1000021 in pIDm:
