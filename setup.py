...
sys.path.insert(0, "./")
from smodels.installation import (
    version,
    authors,
    requirements,
...
def listDirectory(dirname):
    ...
    for filename in files:
        ...
        if (
            ...
            or extension in [".out", ".tgz", ".1"]
            or filename in ["Makefile", "README"]
        ):
            continue
        ret.append(fullname)
    return ret
...
def dataFiles():
    ...
    for directory in [
        ...
        "smodels/etc/",
        "smodels/lib/nllfast/nllfast-1.2/",
        "smodels/lib/nllfast/nllfast-2.1/",
        "smodels/lib/nllfast/nllfast-3.1/",
        "smodels/lib/pythia6/",
        "smodels/lib/pythia8/",
    ]:
