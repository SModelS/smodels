...
nitpick_ignore = [
    ...
    ("py:obj", "inputJsons"),
    ("py:obj", "channelsInfo"),
    ("py:obj", "zeroSignalsFlag"),
    ("py:obj", "nWS"),
    ("py:obj", "patches"),
    ("py:obj", "workspaces"),
    ("py:obj", "cl"),
    ("py:obj", "scale"),
    ("py:obj", "alreadyBeenThere"),
]
...
latex_documents = [("index", "SModelSManual.tex", "SModelS Manual", authors(), "howto")]
...
man_pages = [("index", "smodelsmanual", "SModelS Manual", [authors()], 1)]
...
texinfo_documents = [
    (
        ...
        authors(),
        "SModelSManual",
        "SModelS -- a tool to make systematic use of LHC results.",
        "Miscellaneous",
    ),
]
