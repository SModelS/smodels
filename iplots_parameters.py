...
ctau_hover_information={'ctau_chi1+':1000024}
...
smodels_hover_information=['SmodelS_excluded','r_max','chi2','Tx','Analysis','MT_max','MT_max_xsec','file']
...
plot_list=['SmodelS_excluded','r_max','chi2','Tx','Analysis','MT_max','MT_max_xsec','MT_long_xsec','MT_asym_xsec']
