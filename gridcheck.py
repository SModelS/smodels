...
#  for gluinomass in range(1000,1100,100):
    ...
    res = NLLXSec.getNLLfast(process = "st", pdf = 'cteq', squarkmass=float(squarkmass), gluinomass=float(gluinomass), Energy = energy, base="./nllfast/", interpolate=True )
