...
nu = MultiParticle(
    "nu", [nue, numu, nuta, nue.chargeConjugate(), numu.chargeConjugate(), nuta.chargeConjugate()]
)
##-----------------------------------------------------------------------------------------------------------------------------
...
gluino = Particle(label="gluino", Z2parity=-1, eCharge=0, colordim=8, spin=1.0 / 2.0)
chargino = Particle(label="C1+", Z2parity=-1, eCharge=1, colordim=0, spin=1.0 / 2.0)
...
finalStates = Model(SMparticles=allFinalStates, BSMparticles=[], label="DB Final States (default)")
