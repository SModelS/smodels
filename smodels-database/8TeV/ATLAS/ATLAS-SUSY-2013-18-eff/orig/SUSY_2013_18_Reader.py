...
Map_Multiplier('T1tttt'  , 'SR-0l-7j-A',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,2, 10000)
Map_Multiplier('T1tttt'  , 'SR-0l-7j-B',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,3, 10000)
Map_Multiplier('T1tttt'  , 'SR-0l-7j-C',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,4, 10000)
Map_Multiplier('T1tttt'  , 'SR-1l-6j-A',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,5, 10000)
Map_Multiplier('T1tttt'  , 'SR-1l-6j-B',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,6, 10000)
Map_Multiplier('T1tttt'  , 'SR-1l-6j-C',    'Acc_fig13_T1tttt.txt',    'Eff_fig14_T1tttt.txt'       ,3,7, 10000)



T1tttt_X  , T1tttt_Y = Reading_Values('T1tttt_Obs_Line.txt',2,2)
...
T1tttt_X , T1tttt_Y, T1tttt_UL = Reading_Values('T1tttt_XSecUL.txt',3,3)
