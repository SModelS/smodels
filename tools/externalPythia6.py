...
class ExternalPythia6(ExternalTool):
  ...
  def compile ( self ):
     """ compile pythia_lhe """
     print "[ExternalPythia6] trying to compile pythia:"
  ...
  def fetch ( self, verbose=True ):
    ...
    f=open( tempfile,"w")
    if verbose: print "[ExternalPythia6] fetching tarball ...",
    ...
    if verbose:
      print "done."
      print "[ExternalPythia6] untarring ...",
...
if __name__ == "__main__":
    ...
    print "[externalPythia6.py] installed:",tool.installDirectory()
    print "[externalPythia6.py] check:",tool.checkInstallation()
