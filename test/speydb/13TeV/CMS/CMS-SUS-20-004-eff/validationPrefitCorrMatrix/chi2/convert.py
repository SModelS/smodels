...
info.sqrts = '13.0*TeV'
info.lumi = 137
info.prettyName = 'search for higgsinos'
info.publication = "JHEP 05 (2022) 014, https://doi.org/10.1007/JHEP05(2022)014"
info.private = False
...
# info.comment = "we have an artefact im TChiHH stemming from the fact that we have a plane at mslp = 0 that extends the 2d-plane to higher mother masses. i suggest we cut off the 1d-plane."
info.comment = "For TChiHH we did not add the axino results, as that would give us an unrealistic interpolation for mother masses between 800 and 1200 gev"
