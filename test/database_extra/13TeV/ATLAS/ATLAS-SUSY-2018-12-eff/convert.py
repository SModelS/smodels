...
yields = {
    "SRATT": {"obsN": 4, "bgExp": 3.2, "expErr": 0.5, "ul": 0.04},
...
for SR, data in yields.items():
    ...
    T2tt_1.setSources(
        ...
        dataFiles=[
            ...
            (f"orig/Acc_{SR}.csv", f"orig/Eff_{SR}.csv"),
        ],
        dataFormats=["csv"] * 6 + ["mcsv"],
        units=[None] * 6 + [multiplier],
    )
