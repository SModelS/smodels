...
exp_limit = TH2F("","",20,600.,1100.,32,0.,800.)
...
#plane.SetLogz()
exp_limit.GetXaxis().SetTitle("m_{#tilde{g}} (GeV)")
...
#Legend
leg = TLegend(0.4987437,0.7736944,0.8178392,0.9787234)
...
if metadata['title']:
  ...
  tit = TPaveLabel(0.01005025,0.8317215,0.3228643,0.9825919,title,"brNDC")
  tit.SetBorderSize(4)
  tit.SetFillColor(0)
  tit.SetTextFont(42)
