...
sqrts = addunit(8,"TeV")
maxOrder = 2 # comput at NLL

if computeXsecs:
    xsecs = xsecComputer.computeXSec(sqrts, maxOrder, ioPar.nevts, slhafile)
...
#decomposition
smstoplist = slhaDecomposer.decompose(slhafile, sigmacut, doCompress=ioPar.doCompress,doInvisible=ioPar.doInvisible, minmassgap=ioPar.minmassgap)
