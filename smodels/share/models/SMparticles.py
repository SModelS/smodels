...
##-----------------------------------------------------------------------------------------------------------------------------
##Neutrinos
nue = Particle(Z2parity='even', label='nue', pdg=12, mass=0.*MeV, eCharge=0, colordim=0, spin=1./2, totalwidth = 0.*GeV, decays=[], _isMET=True)
numu = Particle(Z2parity='even', label='numu', pdg=14, mass=0.*MeV, eCharge=0, colordim=0, spin=1./2, totalwidth = 0.*GeV, decays=[], _isMET=True)
nuta = Particle(Z2parity='even', label='nuta', pdg=16, mass=0.*MeV, eCharge=0, colordim=0, spin=1./2, totalwidth = 0.*GeV, decays=[], _isMET=True)
