...
^^^^^^^^^^^^^^^^^^^^^
  ...
  * Database extension, added new results from 4 ATLAS and 10 CMS analyses:
     - results from ATLAS: 
       ATLAS-SUSY-2018-08 (UL+EM), ATLAS-SUSY-2018-40 (UL+EM), ATLAS-SUSY-2018-41 (UL+EM), ATLAS-SUSY-2019-09 (UL+EM, full likelihood)
     - results from CMS:
       CMS-SUS-16-050 (EM), CMS-SUS-18-004 (UL), CMS-SUS-18-007 (UL), CMS-SUS-19-008 (UL), CMS-SUS-19-011 (UL), CMS-SUS-20-001 (UL), CMS-SUS-20-002 (UL)
