...
argparser.add_argument(
    "-no", "--noUpdate", help="do not update the lastUpdate field.", action="store_true"
)
argparser.add_argument(
    "-r", "--resetValidation", help="reset the validation flag", action="store_true"
)
argparser.add_argument(
    "-v",
    "--verbose",
...
argparser.add_argument("-n", "--ntoys", help="number of Monte Carlo toys", default=50000, type=int)
...
aggregation = [
    ...
    [4],
    [5],
    [7, 12, 13, 16, 17, 18, 21, 28, 29, 30, 32, 33, 34, 36, 37, 58, 68, 69, 70, 82],
    [8],
    [9],
    [14],
    [15],
...
info.createCovarianceMatrix(
    "orig/CMS-SUS-16-050_Figure-aux_001.root",
    "total_covar",
    addOrder=True,
...
creator = DatasetsFromLatex(
    "orig/tables.tex", max_datasets=max_datasets, ds_name="t#1b#2MT2#3MET#4", aggregate=aggregation
)
...
for ctr, dataset in enumerate(creator):
    ...
    # ----exclusion source----
    T2tt_1.addSource("efficiencyMap", "orig/acc_maps_T2tt.root", "root", objectName=objNames)
    T2tt_1.addSource(
        "obsExclusion", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ObsLim"
    )
    T2tt_1.addSource(
        "obsExclusionP1", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ObsLimSup"
    )
    T2tt_1.addSource(
        "obsExclusionM1", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ObsLimSdn"
    )
    T2tt_1.addSource(
        "expExclusion", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ExpLim"
    )
    T2tt_1.addSource(
        "expExclusionP1", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ExpLimSup"
    )
    T2tt_1.addSource(
        "expExclusionM1", "orig/CMS-SUS-16-050_Figure_008.root", "root", objectName="ExpLimSdn"
    )
    ...
    # ----exclusion source----
    T1tttt_1.addSource("efficiencyMap", "orig/acc_maps_T1tttt.root", "root", objectName=objNames)
    T1tttt_1.addSource(
        "obsExclusion", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ObsLim"
    )
    T1tttt_1.addSource(
        "obsExclusionP1", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ObsLimSup"
    )
    T1tttt_1.addSource(
        "obsExclusionM1", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ObsLimSdn"
    )
    T1tttt_1.addSource(
        "expExclusion", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ExpLim"
    )
    T1tttt_1.addSource(
        "expExclusionP1", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ExpLimSup"
    )
    T1tttt_1.addSource(
        "expExclusionM1", "orig/CMS-SUS-16-050_Figure_009-a.root", "root", objectName="ExpLimSdn"
    )
    ...
    # ----exclusion source----
    T5tctc_1.addSource("efficiencyMap", "orig/acc_maps_T5ttcc.root", "root", objectName=objNames)
    T5tctc_1.addSource(
        "obsExclusion", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ObsLim"
    )
    T5tctc_1.addSource(
        "obsExclusionP1", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ObsLimSup"
    )
    T5tctc_1.addSource(
        "obsExclusionM1", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ObsLimSdn"
    )
    T5tctc_1.addSource(
        "expExclusion", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ExpLim"
    )
    T5tctc_1.addSource(
        "expExclusionP1", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ExpLimSup"
    )
    T5tctc_1.addSource(
        "expExclusionM1", "orig/CMS-SUS-16-050_Figure_009-d.root", "root", objectName="ExpLimSdn"
    )
