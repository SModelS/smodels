...
info.sqrts 			= 13
info.lumi 			= 139
info.prettyName 	= '2 OS l'
info.private 		= False
info.arxiv 			= 'https://arxiv.org/abs/1908.08215'
info.contact 		= 'atlas-phys-susy-conveners@cern.ch'
info.publication 	= 'Eur. Phys. J. C 80 (2020) 123'
info.publicationDOI = 'https://doi.org/10.1140/epjc/s10052-019-7594-6'
info.implementedBy  = "Philipp Neuhuber, Timothée Pascal"
info.comment        = 'Must keep CRs in HistFactory json file for good validation.'
# info.jsonFiles      = "{'bkgonly_simplified.json' :"+str(SRlist)+"}"
info.includeCRs     = True
# info.mlModels = { 'NNAsimov_C1C1WW_v1.onnx': ['SRDF_0a_cuts', 'SRDF_0b_cuts', 'SRDF_0c_cuts', 'SRDF_0d_cuts', 'SRDF_0e_cuts', 'SRDF_0f_cuts', 'SRDF_0g_cuts', 'SRDF_0h_cuts', 'SRDF_0i_cuts', 'SRDF_1a_cuts', 'SRDF_1b_cuts', 'SRDF_1c_cuts', 'SRDF_1d_cuts', 'SRDF_1e_cuts', 'SRDF_1f_cuts', 'SRDF_1g_cuts', 'SRDF_1h_cuts', 'SRDF_1i_cuts', 'SRSF_0a_cuts', 'SRSF_0b_cuts', 'SRSF_0c_cuts', 'SRSF_0d_cuts', 'SRSF_0e_cuts', 'SRSF_0f_cuts', 'SRSF_0g_cuts', 'SRSF_0h_cuts', 'SRSF_0i_cuts', 'SRSF_1a_cuts', 'SRSF_1b_cuts', 'SRSF_1c_cuts', 'SRSF_1d_cuts', 'SRSF_1e_cuts', 'SRSF_1f_cuts', 'SRSF_1g_cuts', 'SRSF_1h_cuts', 'SRSF_1i_cuts']}
info.mlModels = { 'NNAsimov_C1C1WW_v1.onnx': [ { 'smodels': 'SRDF_0a_cuts'}, 
    { 'smodels': 'SRDF_0b_cuts'}, 
    { 'smodels': 'SRDF_0c_cuts'}, 
    { 'smodels': 'SRDF_0d_cuts'}, 
    { 'smodels': 'SRDF_0e_cuts'}, 
    { 'smodels': 'SRDF_0f_cuts'}, 
    { 'smodels': 'SRDF_0g_cuts'}, 
    { 'smodels': 'SRDF_0h_cuts'}, 
    { 'smodels': 'SRDF_0i_cuts'}, 
    { 'smodels': 'SRDF_1a_cuts'}, 
    { 'smodels': 'SRDF_1b_cuts'}, 
    { 'smodels': 'SRDF_1c_cuts'}, 
    { 'smodels': 'SRDF_1d_cuts'}, 
    { 'smodels': 'SRDF_1e_cuts'}, 
    { 'smodels': 'SRDF_1f_cuts'}, 
    { 'smodels': 'SRDF_1g_cuts'}, 
    { 'smodels': 'SRDF_1h_cuts'}, 
    { 'smodels': 'SRDF_1i_cuts'}, 
    { 'smodels': 'SRSF_0a_cuts'}, 
    { 'smodels': 'SRSF_0b_cuts'}, 
    { 'smodels': 'SRSF_0c_cuts'}, 
    { 'smodels': 'SRSF_0d_cuts'}, 
    { 'smodels': 'SRSF_0e_cuts'}, 
    { 'smodels': 'SRSF_0f_cuts'}, 
    { 'smodels': 'SRSF_0g_cuts'}, 
    { 'smodels': 'SRSF_0h_cuts'}, 
    { 'smodels': 'SRSF_0i_cuts'}, 
    { 'smodels': 'SRSF_1a_cuts'}, 
    { 'smodels': 'SRSF_1b_cuts'}, 
    { 'smodels': 'SRSF_1c_cuts'},
    { 'smodels': 'SRSF_1d_cuts'}, 
    { 'smodels': 'SRSF_1e_cuts'}, 
    { 'smodels': 'SRSF_1f_cuts'}, 
    { 'smodels': 'SRSF_1g_cuts'}, 
    { 'smodels': 'SRSF_1h_cuts'}, 
    { 'smodels': 'SRSF_1i_cuts'},
	  { 'onnx': 'CRVZ_cuts', 'type': 'CR' },
	  { 'onnx': 'CRWW_cuts', 'type': 'CR' },
	  { 'onnx': 'CRtop_cuts', 'type': 'CR' },
    ]}
