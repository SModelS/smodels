...
class CombineElementsTest(unittest.TestCase):
    ...
    def testCombineElements(self):   
        ...
        p1 = Particle(Z2parity='odd', label='p1', pdg=100, mass=100.*GeV, eCharge=None, colordim=None, spin=None, width=None, branches=None) 
        ...
        p2 = Particle(Z2parity='odd', label='p2', pdg=101, mass=100.*GeV, eCharge=None, colordim=None, spin=None, width=None, branches=None) 
