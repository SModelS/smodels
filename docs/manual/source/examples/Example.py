...
def main():
    ...
    if len(toplist) > m:
        top = toplist[m]
        print(
            "\t\t %i-th topology  = " % m, top, "with total cross section =", top.getTotalWeight()
        )
    ...
    for expResult in listOfExpRes:
        ...
        for theoryPrediction in predictions:
            ...
            print(
                "Condition Violation = ", theoryPrediction.conditions
            ...
            if dataset.getType() == "efficiencyMap":
                ...
                print(
                    "L_BSM, L_SM, L_max = %1.3E, %1.3E, %1.3E"
                    % (
                        theoryPrediction.likelihood(),
                        theoryPrediction.lsm(),
                        theoryPrediction.lmax(),
                    )
                )
            if r > rmax:
                rmax = r
    ...
    uncovered = coverage.Uncovered(toplist, sqrts=13.0 * TeV)
