...
for FILE in ['AccXEff_T1_SR5j.txt', 'AccXEff_T2_SR4jt.txt', 'AccXEff_T2_SR2jt.txt', 'AccXEff_T2_SR2jl.txt', 'AccXEff_T2_SR2jm.txt', 'AccXEff_T2_SR6jt.txt', 'AccXEff_T1_SR6jt.txt', 'AccXEff_T1_SR2jm.txt', 'AccXEff_T1_SR6jm.txt', 'AccXEff_T1_SR2jt.txt', 'Obs_Line_T2.txt', 'Exp_Line_T1.txt', 'AccXEff_T2_SR5j.txt', 'Exp_Line_T2.txt', 'Obs_Line_T1.txt', 'AccXEff_T1_SR2jl.txt', 'AccXEff_T2_SR6jm.txt', 'AccXEff_T1_SR4jt.txt']:
    print FILE
    if ('Line' in FILE):
        X, Y = Reading_Values(FILE,2,2)
        Simple_Exclusion_Producer(X,Y,FILE,FILE.replace('txt','dat') )
    elif ('Eff' in FILE):
 
        X, Y, Z= Reading_Values(FILE,3,3)
        Simple_Map_Producer(X,Y,Z,'EM', FILE.replace('txt','dat') )
