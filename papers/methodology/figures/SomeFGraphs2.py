...
vtx2b = Vertex(0.7, -2., mark=CIRCLE)
...
out1 = Point(-0.25,  2)
out2 = Point(0.95, -2.5)
out2a = Point(0.85, -1.5)
out3 = Point(1.25,  2)
out4 = Point(0.85, -2.5)
#R-even particles
even1 = Fermion(vtx1, out1).addLabel("$l^+$", pos=0.7, displace=-0.2)
even2a = Photon(vtx2, vtx2b).addLabel("$Z^*$", pos=0.7, displace=0.2)
even2 = Fermion(vtx2b, out2).addLabel("$l+$", pos=0.7, displace=-0.2)
even3 = Fermion(vtx3, out3).addLabel("$\\nu$", pos=0.7, displace=-0.2)
even4 = Fermion(vtx2b, out4).addLabel("$l^-$", pos=0.7, displace=0.2)
