...
exp_limit = TH2F("","",11,100.,375.,12,0.,300.)
...
plane.SetLogz()
exp_limit.GetXaxis().SetTitle("m_{#tilde{l}} (GeV)")
...
exp_limit.GetZaxis().SetRangeUser(zmin,100.*zmax)
...
#Legend
leg = TLegend(0.5062814,0.7466151,0.8278894,0.967118)
...
if metadata['title']:
  ...
  tit = TPaveLabel(0.01130653,0.8375242,0.4610553,0.9883946,title,"brNDC")
  tit.SetBorderSize(4)
  tit.SetFillColor(0)
  tit.SetTextFont(42)
...
gPad.Update()
c1.Print('2D-'+'TSlepSlep.eps')
c1.Print('2D-'+'TSlepSlep.root')
