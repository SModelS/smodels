...
sdl = Particle(Z2parity=-1, label="sd_L", pdg=1000001, eCharge=-1.0 / 3, colordim=3, spin=0)
sul = Particle(Z2parity=-1, label="su_L", pdg=1000002, eCharge=2.0 / 3, colordim=3, spin=0)
sdr = Particle(Z2parity=-1, label="sd_R", pdg=2000001, eCharge=-1.0 / 3, colordim=3, spin=0)
sur = Particle(Z2parity=-1, label="su_R", pdg=2000002, eCharge=2.0 / 3, colordim=3, spin=0)

# 2nd generation squarks and its conjugates:
ssl = Particle(Z2parity=-1, label="ss_L", pdg=1000003, eCharge=-1.0 / 3, colordim=3, spin=0)
scl = Particle(Z2parity=-1, label="sc_L", pdg=1000004, eCharge=2.0 / 3, colordim=3, spin=0)
ssr = Particle(Z2parity=-1, label="ss_R", pdg=2000003, eCharge=-1.0 / 3, colordim=3, spin=0)
scr = Particle(Z2parity=-1, label="sc_R", pdg=2000004, eCharge=2.0 / 3, colordim=3, spin=0)

# 3rd generation squarks and its conjugates:
sb1 = Particle(Z2parity=-1, label="sb_1", pdg=1000005, eCharge=-1.0 / 3, colordim=3, spin=0)
st1 = Particle(Z2parity=-1, label="st_1", pdg=1000006, eCharge=2.0 / 3, colordim=3, spin=0)
sb2 = Particle(Z2parity=-1, label="sb_2", pdg=2000005, eCharge=-1.0 / 3, colordim=3, spin=0)
st2 = Particle(Z2parity=-1, label="st_2", pdg=2000006, eCharge=2.0 / 3, colordim=3, spin=0)
...
# Gluino:
gluino1 = Particle(Z2parity=-1, label="gluino1", pdg=1000021, eCharge=0, colordim=8, spin=1.0 / 2)
gluino2 = Particle(Z2parity=-1, label="gluino2", pdg=2000021, eCharge=0, colordim=8, spin=1.0 / 2)

# Neutralinos
n1 = Particle(Z2parity=-1, label="N1", pdg=1000022, eCharge=0, colordim=1, spin=1.0 / 2)
n2 = Particle(Z2parity=-1, label="N2", pdg=1000023, eCharge=0, colordim=1, spin=1.0 / 2)
n3 = Particle(Z2parity=-1, label="N3", pdg=1000025, eCharge=0, colordim=1, spin=1.0 / 2)
n4 = Particle(Z2parity=-1, label="N4", pdg=1000035, eCharge=0, colordim=1, spin=1.0 / 2)
n5 = Particle(Z2parity=-1, label="N5", pdg=1000045, eCharge=0, colordim=1, spin=1.0 / 2)
n6 = Particle(Z2parity=-1, label="N6", pdg=1000055, eCharge=0, colordim=1, spin=1.0 / 2)

# Charginos
c1 = Particle(Z2parity=-1, label="C1+", pdg=1000024, eCharge=1, colordim=1, spin=1.0 / 2)
c2 = Particle(Z2parity=-1, label="C2+", pdg=1000037, eCharge=1, colordim=1, spin=1.0 / 2)
c3 = Particle(Z2parity=-1, label="C3+", pdg=1000047, eCharge=1, colordim=1, spin=1.0 / 2)

# Gravitino
gravitino = Particle(Z2parity=-1, label="G", pdg=1000039, eCharge=1, colordim=1, spin=1.0 / 2)
...
# Sgluons
sgluon1 = Particle(Z2parity=-1, label="sgluon1", pdg=3000021, eCharge=0, colordim=8, spin=1.0 / 2)
sgluon1 = Particle(Z2parity=-1, label="sgluon2", pdg=3000022, eCharge=0, colordim=8, spin=1.0 / 2)
