...
T1bbbb.dataUrl = (
    "https://twiki.cern.ch/twiki/pub/CMSPublic/PhysicsResultsSUS12024/T1bbbb_exclusions_corrected.C"
)
T1bbbb.setSources(
    dataLabels=["obsExclusion", "upperLimits"],
    dataFiles=["orig/graph_smoothed_Obs_T1bbbb.root", "orig/hXsec_exp_corr_T1bbbb.root"],
    dataFormats=["root", "root"],
    objectNames=["graph_smoothed_Obs_T1bbbb", "hXsec_exp_corr"],
)
...
T1tttt.dataUrl = (
    "https://twiki.cern.ch/twiki/pub/CMSPublic/PhysicsResultsSUS12024/T1tttt_exclusion_corrected.C"
)
T1tttt.setSources(
    dataLabels=["obsExclusion", "upperLimits"],
    dataFiles=["orig/graph_smoothed_Obs_T1tttt.root", "orig/hXsec_obs_final_T1tttt.root"],
    dataFormats=["root", "root"],
    objectNames=["graph_smoothed_Obs_T1tttt", "hXsec_obs_final"],
)
