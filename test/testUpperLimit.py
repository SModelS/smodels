...
class UpperLimitTest(unittest.TestCase):
    ...
    def testDirectDecay(self):
        ...
        ul = expRes[0].getUpperLimitFor (txname= "T2bb",  mass=[[400*GeV,100*GeV],[400*GeV,100*GeV]] ).asNumber ( pb )
    ...
    def testOutofBounds(self):
        ...
        ul = expRes[0].getUpperLimitFor (txname= "T6bbWW",  mass=[[400*GeV,250*GeV,100*GeV],[400*GeV,250*GeV,100*GeV]] )
        self.assertTrue ( ul == None )

    def testCascadeDecay(self):
        expRes=database.getExpResults ( analysisIDs = [ "ATLAS-SUSY-2013-05" ], datasetIDs= [ None ] , txnames= [ "T6bbWW" ] )
        ul = expRes[0].getUpperLimitFor (txname= "T6bbWW",  mass=[[150*GeV,140*GeV,135*GeV],[150*GeV,140*GeV,135*GeV]] ).asNumber ( pb )
