...
class ElementTest(unittest.TestCase):
    ...
    def testElementMassComp(self):
        ...
        # Compress everything
        el1Comp = el1.massCompress(minmassgap=10.0 * GeV)  # Fully compress
        b1Comp = Branch()
    ...
    def testElementCombine(self):
        ...
        n3.mass = 320.0 * GeV
        n1.totalwidth = 0.0 * GeV
        n2.totalwidth = 0.0 * GeV  # just for the sake of the example
        ...
        w2 = w1.copy()
        w2.xSections[0].value = 22.0 * fb
        w3 = w1.copy()
        w3.xSections[0].value = 2.0 * fb
        ...
        el3.weight = w3
        el1 += el2
        self.assertEqual(el1.weight[0].value, 32.0 * fb)
        self.assertEqual(el1.pdg, [[1000021, [1000022, 1000023]], [1000021, [1000022, 1000023]]])
        self.assertEqual(el1.getAverage("mass"), [[gluino.mass, (n1.mass + n2.mass) / 2.0]] * 2)
        el1 += el3
        self.assertEqual(el1.weight[0].value, 34.0 * fb)
        self.assertEqual(el1.pdg, [[1000021, [1000022, 1000023]], [1000021, [1000022, 1000023]]])
        self.assertEqual(el1.getAverage("mass"), [[gluino.mass, (n1.mass + n2.mass) / 2.0]] * 2)
