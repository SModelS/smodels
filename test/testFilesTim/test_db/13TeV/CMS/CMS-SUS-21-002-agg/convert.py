...
#+++++++ global info block ++++++++++++++
info = MetaInfoInput('CMS-SUS-21-002-agg')
...
dsnames = ['b_veto_SR', 'WH_SR', 'W_SR', 'H_SR']

b_veto_summed_nobs = sum(b_veto_nobs)
b_veto_summed_nbg = sum(b_veto_nbg)
b_veto_summed_bgerr = sum(b_veto_bgerr)

WH_SR_summed_nobs = sum(WH_SR_nobs)
WH_SR_summed_nbg = sum(WH_SR_nbg)
WH_SR_summed_bgerr = sum(WH_SR_bgerr)

W_SR_summed_nobs = sum(W_SR_nobs)
W_SR_summed_nbg = sum(W_SR_nbg)
W_SR_summed_bgerr = sum(W_SR_bgerr)

H_SR_summed_nobs = sum(H_SR_nobs)
H_SR_summed_nbg = sum(H_SR_nbg)
H_SR_summed_bgerr = sum(H_SR_bgerr)
...
dataset.setInfo(dataType = 'efficiencyMap', dataId = dsname,
                 observedN = b_veto_summed_nobs, expectedBG = b_veto_summed_nbg, bgError = b_veto_summed_bgerr, comment = dsname )
...
TChiWW_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWW_bvetoSR.root', 'root', objectName = 'accEff;1')
...
TChiWZ_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWZ_bvetoSR.root', 'root', objectName = 'accEff;1')
...
TChiWH_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWH_WH_SR.root', 'root', objectName = 'accEff;1')
TChiWH_1.efficiencyMap._unit = "0."
...
dataset = DataSetInput( dsname )
dataset.setInfo(dataType = 'efficiencyMap', dataId = dsname,
                 observedN = WH_SR_summed_nobs, expectedBG = WH_SR_summed_nbg, bgError = WH_SR_summed_bgerr, comment = dsname )
...
'''
TChiWW_1 = TChiWW.addMassPlane(2*[[x,y]])
TChiWW_1.addSource( 'efficiencyMap', f'orig/AllBinAccXEff_bTag_TChiWW.root', 'root', objectName = 'AccXEff_WHSR;1')
TChiWW_1.addSource( 'obsExclusion', 'orig/TChiWW_obsExclusion.csv', 'csv' )
TChiWW_1.addSource( 'obsExclusionP1', 'orig/TChiWW_obsExclusionP1.csv', 'csv' )
TChiWW_1.addSource( 'obsExclusionM1', 'orig/TChiWW_obsExclusionM1.csv', 'csv' )
TChiWW_1.addSource( 'expExclusion', 'orig/TChiWW_expExclusion.csv', 'csv')
...
TChiWZ_1 = TChiWZ.addMassPlane(2*[[x,y]])
TChiWZ_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWZ_WH_SR.root', 'root', objectName = 'accEff;1')
TChiWZ_1.addSource( 'obsExclusion', 'orig/TChiWZ_obsExclusion.csv', 'csv' )  
TChiWZ_1.addSource( 'obsExclusionP1', 'orig/TChiWZ_obsExclusionP1.csv', 'csv' )
TChiWZ_1.addSource( 'obsExclusionM1', 'orig/TChiWZ_obsExclusionM1.csv', 'csv' ) 
TChiWZ_1.addSource( 'expExclusion', 'orig/TChiWZ_expExclusion.csv', 'csv')
...
dataset = DataSetInput( dsname )
dataset.setInfo(dataType = 'efficiencyMap', dataId = dsname,
                 observedN = W_SR_summed_nobs, expectedBG = W_SR_summed_nbg, bgError = W_SR_summed_bgerr, comment = dsname )
...
'''
TChiWW_1 = TChiWW.addMassPlane(2*[[x,y]])
TChiWW_1.addSource( 'efficiencyMap', f'orig/AllBinAccXEff_bTag_TChiWW.root', 'root', objectName = 'AccXEff_WSR;1')
TChiWW_1.addSource( 'obsExclusion', 'orig/TChiWW_obsExclusion.csv', 'csv' )
TChiWW_1.addSource( 'obsExclusionP1', 'orig/TChiWW_obsExclusionP1.csv', 'csv' )
TChiWW_1.addSource( 'obsExclusionM1', 'orig/TChiWW_obsExclusionM1.csv', 'csv' )
TChiWW_1.addSource( 'expExclusion', 'orig/TChiWW_expExclusion.csv', 'csv')
...
TChiWZ_1 = TChiWZ.addMassPlane(2*[[x,y]])
TChiWZ_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWZ_W_SR.root', 'root', objectName = 'accEff;1')
TChiWZ_1.addSource( 'obsExclusion', 'orig/TChiWZ_obsExclusion.csv', 'csv' )  
TChiWZ_1.addSource( 'obsExclusionP1', 'orig/TChiWZ_obsExclusionP1.csv', 'csv' )
TChiWZ_1.addSource( 'obsExclusionM1', 'orig/TChiWZ_obsExclusionM1.csv', 'csv' ) 
TChiWZ_1.addSource( 'expExclusion', 'orig/TChiWZ_expExclusion.csv', 'csv')
...
TChiWH_1 = TChiWH.addMassPlane(2*[[x,y]])
TChiWH_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWH_W_SR.root', 'root', objectName = 'accEff;1')
TChiWH_1.addSource( 'obsExclusion', 'orig/TChiWH_obsExclusion.csv', 'csv' )  
TChiWH_1.addSource( 'obsExclusionP1', 'orig/TChiWH_obsExclusionP1.csv', 'csv' )
TChiWH_1.addSource( 'obsExclusionM1', 'orig/TChiWH_obsExclusionM1.csv', 'csv' ) 
TChiWH_1.addSource( 'expExclusion', 'orig/TChiWH_expExclusion.csv', 'csv')
...
dataset = DataSetInput( dsname )
dataset.setInfo(dataType = 'efficiencyMap', dataId = dsname,
                 observedN = H_SR_summed_nobs, expectedBG = H_SR_summed_nbg, bgError = H_SR_summed_bgerr, comment = dsname )
...
'''
TChiWW_1 = TChiWW.addMassPlane(2*[[x,y]])
TChiWW_1.addSource( 'efficiencyMap', f'orig/AllBinAccXEff_bTag_TChiWW.root', 'root', objectName = 'AccXEff_HSR;1')
...
TChiWZ_1 = TChiWZ.addMassPlane(2*[[x,y]])
TChiWZ_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWZ_H_SR.root', 'root', objectName = 'accEff;1')
TChiWZ_1.addSource( 'obsExclusion', 'orig/TChiWZ_obsExclusion.csv', 'csv' )  
TChiWZ_1.addSource( 'obsExclusionP1', 'orig/TChiWZ_obsExclusionP1.csv', 'csv' )
TChiWZ_1.addSource( 'obsExclusionM1', 'orig/TChiWZ_obsExclusionM1.csv', 'csv' ) 
TChiWZ_1.addSource( 'expExclusion', 'orig/TChiWZ_expExclusion.csv', 'csv')
...
TChiWH_1 = TChiWH.addMassPlane(2*[[x,y]])
TChiWH_1.addSource( 'efficiencyMap', f'orig/Eff_TChiWH_H_SR.root', 'root', objectName = 'accEff;1')
TChiWH_1.addSource( 'obsExclusion', 'orig/TChiWH_obsExclusion.csv', 'csv' )  
TChiWH_1.addSource( 'obsExclusionP1', 'orig/TChiWH_obsExclusionP1.csv', 'csv' )
TChiWH_1.addSource( 'obsExclusionM1', 'orig/TChiWH_obsExclusionM1.csv', 'csv' ) 
TChiWH_1.addSource( 'expExclusion', 'orig/TChiWH_expExclusion.csv', 'csv')
...
info.createCovarianceMatrix ( "orig/Covariance_matrix.root", histoname = "overall_total_covar;1", addOrder = True, max_datasets = None,  aggregate = aggregates )
