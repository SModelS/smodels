...
info.sqrts 		= 13
info.lumi 		= 139
info.prettyName = '3 l, EWK'
info.publication = "Eur. Phys. J. C 81 (2021) 1118"
info.publicationDOI = "https://doi.org/10.1140/epjc/s10052-021-09749-7"
info.private 	= False
info.arxiv 		= 'https://arxiv.org/abs/2106.01676'
info.contact    = 'atlas-phys-susy-conveners@cern.ch'
# info.jsonFiles = {'bkg_onshell_simplified.json' : ['SRWZ_1', 'SRWZ_2', 'SRWZ_3', 'SRWZ_4', 'SRWZ_5', 'SRWZ_6', 'SRWZ_7', 'SRWZ_8', 'SRWZ_9', 'SRWZ_10', 'SRWZ_11', 'SRWZ_12', 'SRWZ_13', 'SRWZ_14', 'SRWZ_15', 'SRWZ_16', 'SRWZ_17', 'SRWZ_18', 'SRWZ_19', 'SRWZ_20'], 'bkg_offshell_simplified.json' : ['SRhigh_0Jb', 'SRhigh_0Jc', 'SRhigh_0Jd', 'SRhigh_0Je', 'SRhigh_0Jf1', 'SRhigh_0Jf2', 'SRhigh_0Jg1', 'SRhigh_0Jg2', 'SRhigh_nJa', 'SRhigh_nJb', 'SRhigh_nJc', 'SRhigh_nJd', 'SRhigh_nJe', 'SRhigh_nJf', 'SRhigh_nJg', 'SRlow_0Jb', 'SRlow_0Jc', 'SRlow_0Jd', 'SRlow_0Je', 'SRlow_0Jf1', 'SRlow_0Jf2', 'SRlow_0Jg1', 'SRlow_0Jg2', 'SRlow_nJb', 'SRlow_nJc', 'SRlow_nJd', 'SRlow_nJe', 'SRlow_nJf1', 'SRlow_nJf2', 'SRlow_nJg1', 'SRlow_nJg2'], 'SR_WH_0j_fake_bkgonly.json' : ['SR_WH_0j'], 'SR_WH_nj_fake_bkgonly.json' : ['SR_WH_nj'], 'SR_WH_DFOS_fake_bkgonly.json' : ['SR_WH_DFOS']}
# jsonFiles_FullLikelihood = {'bkg_onshell.json' : ['SRWZ_1', 'SRWZ_2', 'SRWZ_3', 'SRWZ_4', 'SRWZ_5', 'SRWZ_6', 'SRWZ_7', 'SRWZ_8', 'SRWZ_9', 'SRWZ_10', 'SRWZ_11', 'SRWZ_12', 'SRWZ_13', 'SRWZ_14', 'SRWZ_15', 'SRWZ_16', 'SRWZ_17', 'SRWZ_18', 'SRWZ_19', 'SRWZ_20'], 'bkg_offshell.json' : ['SRhigh_0Jb', 'SRhigh_0Jc', 'SRhigh_0Jd', 'SRhigh_0Je', 'SRhigh_0Jf1', 'SRhigh_0Jf2', 'SRhigh_0Jg1', 'SRhigh_0Jg2', 'SRhigh_nJa', 'SRhigh_nJb', 'SRhigh_nJc', 'SRhigh_nJd', 'SRhigh_nJe', 'SRhigh_nJf', 'SRhigh_nJg', 'SRlow_0Jb', 'SRlow_0Jc', 'SRlow_0Jd', 'SRlow_0Je', 'SRlow_0Jf1', 'SRlow_0Jf2', 'SRlow_0Jg1', 'SRlow_0Jg2', 'SRlow_nJb', 'SRlow_nJc', 'SRlow_nJd', 'SRlow_nJe', 'SRlow_nJf1', 'SRlow_nJf2', 'SRlow_nJg1', 'SRlow_nJg2'], 'SR_WH_0j_fake_bkgonly.json' : ['SR_WH_0j'], 'SR_WH_nj_fake_bkgonly.json' : ['SR_WH_nj'], 'SR_WH_DFOS_fake_bkgonly.json' : ['SR_WH_DFOS']}
SRlist = {'bkg_onshell_simplified.json' : ['SRWZ_1', 'SRWZ_2', 'SRWZ_3', 'SRWZ_4', 'SRWZ_5', 'SRWZ_6', 'SRWZ_7', 'SRWZ_8', 'SRWZ_9', 'SRWZ_10', 'SRWZ_11', 'SRWZ_12', 'SRWZ_13', 'SRWZ_14', 'SRWZ_15', 'SRWZ_16', 'SRWZ_17', 'SRWZ_18', 'SRWZ_19', 'SRWZ_20'], 'bkg_offshell_simplified.json' : ['SRhigh_0Jb', 'SRhigh_0Jc', 'SRhigh_0Jd', 'SRhigh_0Je', 'SRhigh_0Jf1', 'SRhigh_0Jf2', 'SRhigh_0Jg1', 'SRhigh_0Jg2', 'SRhigh_nJa', 'SRhigh_nJb', 'SRhigh_nJc', 'SRhigh_nJd', 'SRhigh_nJe', 'SRhigh_nJf', 'SRhigh_nJg', 'SRlow_0Jb', 'SRlow_0Jc', 'SRlow_0Jd', 'SRlow_0Je', 'SRlow_0Jf1', 'SRlow_0Jf2', 'SRlow_0Jg1', 'SRlow_0Jg2', 'SRlow_nJb', 'SRlow_nJc', 'SRlow_nJd', 'SRlow_nJe', 'SRlow_nJf1', 'SRlow_nJf2', 'SRlow_nJg1', 'SRlow_nJg2'], 'SR_WH_0j_fake_bkgonly.json' : ['SR_WH_0j'], 'SR_WH_nj_fake_bkgonly.json' : ['SR_WH_nj'], 'SR_WH_DFOS_fake_bkgonly.json' : ['SR_WH_DFOS']}
SRdicts = {}
for jsonFile,SRs in SRlist.items():
    dicts = []
    for SR in SRs:
        pyhfname = SR
        if "SRWZ" in pyhfname:
            pyhfname = pyhfname.replace("SRWZ_","SR")
            pyhfname = pyhfname + "_WZ_cuts"
        if "SRhigh" in pyhfname or "SRlow" in pyhfname:
            pyhfname = pyhfname + "_cuts"
        d = { "smodels": SR, "pyhf": pyhfname }
        dicts.append ( d )
    SRdicts[jsonFile]=dicts
info.jsonFiles = SRdicts
fullSRlist = {}
for k,v in SRdicts.items():
    k = k.replace("_simplified","")
    fullSRlist[k]=v
info.jsonFiles_FullLikelihood = fullSRlist
info.includeCRs = True
info.comment = "We created fake jsons files for individual WH SRs in order for TChiWH to compete with TChiWZ(off) when combineSRs=True."
    ...
    for row in reader : #We go rw by row
        if row != [] : #If the row is not empty
            ...
            if row[0] in ['{Regions}','{Regions', 'Region'] : #If the row contains the SR names
                ...
                for element in row :
                    if element != '' and r'\SR' in element : #If the element of the row really is a SR name
...
for topo in tables : #To go through the results
    for SR in tables[topo] :
        ...
        if topo == 'SRWZ' :
            ...
            locals()[SR].setInfo(dataType = 'efficiencyMap', dataId = SR, observedN = int(tables[topo][SR]['observed']), 
                                 expectedBG = tables[topo][SR]['expected'], bgError = tables[topo][SR]['bgError'])
            ...
            TChiWZ.massConstraint       = [['dm > 77.0'], ['dm > 77.0']]
            ...
            TChiWZ_1.exclusionDataUrl  = 'https://doi.org/10.17182/hepdata.95751.v2/t31'
            TChiWZ_1.dataUrl           = 'https://doi.org/10.17182/hepdata.95751.v1/r3'
            TChiWZ_1.setSources(dataLabels = [ 'obsExclusion', 'obsExclusionP1', 'obsExclusionM1',
        ...
        if topo == 'SRlow' or topo == 'SRhigh' :
            ...
            TChiWZoff.massConstraint       = [['dm < 110.0'], ['dm < 110.0']]
            ...
            TChiWZoff_plus.validationTarball = "TChiWZoff.tar.gz"
            TChiWZoff_plus.figureUrl         = 'n/a'
            TChiWZoff_plus.exclusionDataUrl  = 'https://doi.org/10.17182/hepdata.95751.v2/t41'
            TChiWZoff_plus.dataUrl           = 'https://doi.org/10.17182/hepdata.95751.v1/r3'
            TChiWZoff_plus.setSources(dataLabels = [ 'obsExclusion', 'obsExclusionP1', 'obsExclusionM1', 
                                                     'expExclusion', 'expExclusionP1', 'expExclusionM1' ],
                                dataFiles = [ "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),offshell_Obs.csv",
                                              "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),Obs_Up.csv",
                                              "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),Obs_Down.csv",
                                              "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),offshell_Exp.csv",
                                              "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),Exp_Up.csv",
                                              "orig/Fig16bWZExclusion:Wino-bino(+)(Deltam),Exp_Down.csv"],
                                units = [ None ]*6,
                                dataFormats = [ 'csv' ]*6 )
            TChiWZoff_plus.addSource("efficiencyMap", "orig/interpolated_" + SR + "_cuts_winobino(+)_efficiency.csv",
                              unit = "", dataFormat = "csv")
            ...
            TChiWZoff_hino.exclusionDataUrl  = 'https://doi.org/10.17182/hepdata.95751.v2/t63'
            TChiWZoff_hino.dataUrl           = 'https://doi.org/10.17182/hepdata.95751.v1/r3'
            TChiWZoff_hino.setSources(dataLabels = [ 'obsExclusion', 'obsExclusionP1', 'obsExclusionM1',
                                                     'expExclusion', 'expExclusionP1', 'expExclusionM1' ],
...
#                 observedN = 5237.0, expectedBG = 1, bgError = 1,  upperLimit = 10000000*fb, expectedUpperLimit = 10000000*fb)
#
#
# #+++++++ next mass plane block ++++++++++++++
...
# dataset = DataSetInput(SR)
# dataset.setInfo(dataType = 'efficiencyMap', dataId = SR,
#                 observedN = 3149.0, expectedBG = 1, bgError = 1, upperLimit = 10000000*fb, expectedUpperLimit = 10000000*fb)
#
#
# #+++++++ next mass plane block ++++++++++++++
# TChiWZoff                      = dataset.addTxName('TChiWZoff')
...
TChiWH_1.exclusionDataUrl = 'https://doi.org/10.17182/hepdata.95751.v2/t65'
TChiWH_1.dataUrl          = 'https://doi.org/10.17182/hepdata.95751.v2/t92; https://doi.org/10.17182/hepdata.95751.v2/t93'
...
TChiWH_1.exclusionDataUrl = 'https://doi.org/10.17182/hepdata.95751.v2/t65'
TChiWH_1.dataUrl = 'https://doi.org/10.17182/hepdata.95751.v2/t94; https://doi.org/10.17182/hepdata.95751.v2/t95'
TChiWH_1.setSources(dataLabels = [ 'obsExclusion', 'obsExclusionP1', 'obsExclusionM1', 'expExclusion', 'expExclusionP1', 'expExclusionM1'],
                    dataFiles = [ "orig/Fig17WhExclusion,Obs.csv",
                                  "orig/Fig17WhExclusion,Obs_Up.csv",
                                  "orig/Fig17WhExclusion,Obs_Down.csv",
...
TChiWH_1.exclusionDataUrl = 'https://doi.org/10.17182/hepdata.95751.v2/t65'
TChiWH_1.dataUrl = 'https://doi.org/10.17182/hepdata.95751.v2/t96; https://doi.org/10.17182/hepdata.95751.v2/t97'
TChiWH_1.setSources(dataLabels = [ 'obsExclusion', 'obsExclusionP1', 'obsExclusionM1', 'expExclusion', 'expExclusionP1', 'expExclusionM1'],
                    dataFiles = [ "orig/Fig17WhExclusion,Obs.csv",
                                  "orig/Fig17WhExclusion,Obs_Up.csv",
                                  "orig/Fig17WhExclusion,Obs_Down.csv",
