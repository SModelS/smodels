...
class UpperLimitTest(unittest.TestCase):
    def testDirectDecay(self):
        ...
        ul = (
            expRes[0]
            .getUpperLimitFor(txname="T2bb", mass=[[400 * GeV, 100 * GeV], [400 * GeV, 100 * GeV]])
            .asNumber(pb)
        )
    ...
    def testOutofBounds(self):
        expRes = database.getExpResults(
            analysisIDs=["ATLAS-SUSY-2013-05"], datasetIDs=[None], txnames=["T6bbWW"]
        )
        ul = expRes[0].getUpperLimitFor(
            txname="T6bbWW",
