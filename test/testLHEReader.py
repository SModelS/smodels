...
class LHEReaderTest(unittest.TestCase):
    ...
    def testEventDictionaries(self):
        ...
        gluinoDec = [pyslha.Decay(br=1.0, nda=3, ids=[-1, 1, 1000022], parentid=1000021)] * 2
    ...
    def testDictionaries(self):
        ...
        decayRes[1000023] = [
            pyslha.Decay(br=0.8571, ids=[1000022, 25], parentid=1000023, nda=2),
        ...
        decayRes[1000021] = [
            pyslha.Decay(br=0.2500, ids=[-1000024, 4, -3], parentid=1000021, nda=3),
        ...
        for pdg in decayDict:
            if not decayDict[pdg].decays:
                self.assertEqual(decayDict[pdg].totalwidth, 0.0)
