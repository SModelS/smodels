...
exp_limit = TH2F("","",26,150.,800.,16,0.,400.)
...
plane.SetLogz()
exp_limit.GetXaxis().SetTitle("m_{#tilde{t}} (GeV)")
...
#Legend
leg = TLegend(0.5100503,0.7814313,0.821608,0.9961315)
...
if metadata['title']:
  ...
  tit = TPaveLabel(0.02135678,0.8317215,0.3442211,0.9825919,title,"brNDC")
  tit.SetBorderSize(4)
  tit.SetFillColor(0)
  tit.SetTextFont(42)
