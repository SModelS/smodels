 ...
 * :ref:`specific particle and model properties <modelProperties>`, such as masses, branching ratios and cross-sections
...
If the first line contains a comment (after the particle PDG), it will be used
as the particle label, otherwise the particle label will be its PDG number.
The entries 1,2 and 3 three are mapped to the particle's electric charge (eCharge,
