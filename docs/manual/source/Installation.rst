 ...
 * `Resummino <https://resummino.hepforge.org>`_ (requires a C++ compiler and gfortran). In Fedora this tool need boost, boost-devel, gsl and gsl-devel. In Debian/Ubuntu,
 need instead libboost-dev and libgsl-dev.
