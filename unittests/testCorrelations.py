...
class CorrelationsTest(unittest.TestCase):
    ...
    def testDifferentExperiments(self):
        ...
        er2 = database.getExpResults( analysisIDs = [ "CMS-EXO-13-006" ] )[0]
        ds2 = er2.datasets[0]
        # Reset database:
        database.selectExpResults()
    ...
    def testDifferentRuns(self):
        ...
        er2 = database.getExpResults( analysisIDs = [ "ATLAS-SUSY-2016-08" ] )[0]
        ds2 = er2.datasets[0]
        # Reset database:
        database.selectExpResults()
    ...
    def testViaCombinationsMatrix(self):
        ...
        in the test base, ATLAS-SUSY-2013-05 is marked as combinable 
        with ATLAS-SUSY-2013-02
        """
        er1 = database.getExpResults( analysisIDs = [ "ATLAS-SUSY-2013-05" ] )[0]
        ds1 = er1.datasets[0]
        # Reset database:
        ...
        comb = { "ATLAS-SUSY-2013-12": [ "ATLAS-SUSY-2013-05" ] }
        database.combinationsmatrix = comb
    ...
    def testAtDatasetLevel(self):
        ...
        """
        # Using getExpResults keeps only the selected results in the database
        er1 = database.getExpResults( analysisIDs = [ "CMS-PAS-EXO-16-036" ] )[0]
        # Reset database:
        database.selectExpResults()
        # ds1 = er1.datasets[0]
        ds1 = er1.getDataset ( "c000" )
        ds2 = er1.datasets[1]
        ds2 = er1.getDataset ( "c100" )
        er2 = database.getExpResults( analysisIDs = [ "CMS-SUS-16-050-agg" ] )[0]
        # Reset database:
        database.selectExpResults()        
        ds3 = er2.datasets[0]
        ds3 = er2.getDataset ( "ar1" )
        ds4 = er2.datasets[1]
        ds4 = er2.getDataset ( "ar10" )
        self.assertFalse ( ds1.isCombinableWith ( ds3 ) )
