...
shortened version of its string representation, which includes only the |SMS| final states, i.e. the undecayed particles in the topology. For instance, for a |SMS| described by: ::
