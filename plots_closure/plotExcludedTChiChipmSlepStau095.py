...
inputOn= 'TChiChipmSlepStau095-CMS.dat'
...
exp_limit = TH2F("","",28,100.,800.,20,0.,500.)
...
if metadata['title']:
  ...
  tit = TPaveLabel(0.01005025,0.8317215,0.388191,0.9825919,title,"brNDC")
  tit.SetBorderSize(4)
  tit.SetFillColor(0)
  tit.SetTextFont(42)
...
gPad.Update()
c1.Print('2D-'+'TChiChipmSlepStau095.eps')
