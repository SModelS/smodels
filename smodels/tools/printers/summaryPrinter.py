...
class SummaryPrinter(TxTPrinter):
    ...
    def _formatTheoryPredictionList(self, obj):
        ...
        for theoPred in obj._theoryPredictions:
            r = theoPred.getRValue(expected=NllEvalType.observed)
        ...
        for theoPred in theoPredictions:
            ...
            ul = theoPred.getUpperLimit(expected=NllEvalType.observed)
            uls = str(ul)
    ...
    def _formatTheoryPredictionsCombiner(self, obj):
        ...
        # Get r-value:
        r = obj.getRValue()
        r_expected = obj.getRValue(expected=NllEvalType.apriori)
        # Get likelihoods:
