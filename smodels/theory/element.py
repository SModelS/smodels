...
class Element(object):
    ...
    def __init__(self, info=None, fs=None):
        ...
        :parameter info: string describing the element in bracket notation
                         (e.g. [[[e+],[jet]],[[e-],[jet]]])
        :parameter fs: FIXME nasty workaround to comply with Andres 
         changes in smodels-utils:master!!
        """
        if fs!=None:
            print ( "aargh nasty workaround in element to work with Andres changes in smodels-utils" )
