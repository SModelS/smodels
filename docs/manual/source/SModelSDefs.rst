...
of a full model into Simplified Model (:ref:`elements <element>`) are described in :ref:`Theory Definitions <theoryDefs>`,
while the concepts relevant for the database of experimental results are given in :ref:`Database Definitions <databaseDefs>`.
