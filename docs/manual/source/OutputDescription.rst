...
* information about the missing topologies with long-lived particles.
...
* information about the missing topologies with MET decays.
  For definiteness all lists are sorted.
  If **addCoverageID** = True, all the |elements| IDs contributing to the missing topology are shown.
...
* a list of topologies with long-lived particles (if **testCoverage** = True),
  stored under the *Long-lived* key.
  For each list entry, the |element| cross section (weight)
  and the |element| description in :ref:`bracket notation <bracketNotation>` is included.
...
* a list of topologies with displaced (if **testCoverage** = True),
  stored under the *Long-lived* key.
  For each list entry, the |element| cross section (weight)
  and the |element| description in :ref:`bracket notation <bracketNotation>` is included.
...
* a list of topologies with MET decays (if **testCoverage** = True),
  stored under the *Long-lived* key.
  For each list entry, the |element| cross section (weight)
  and the |element| description in :ref:`bracket notation <bracketNotation>` is included.
...
* a list of topologies with displaced decays (if **testCoverage** = True):
