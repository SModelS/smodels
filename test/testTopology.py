...
class TopologyTest(unittest.TestCase):
    def testTopology(self):
        ...
        self.assertEqual(top1.getElements()[0].weight[0].value == 32.0 * fb, True)
        self.assertEqual(top1.getTotalWeight()[0].value == 32.0 * fb, True)
    ...
    def testTopologyList(self):
        ...
        self.assertEqual(topL.getTotalWeight()[0].value == 34.0 * fb, True)
