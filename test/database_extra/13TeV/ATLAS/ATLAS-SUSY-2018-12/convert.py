...
T2tt_1.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-12/figaux_01a.png"
)
...
T2tt_1.setSources(
    ...
    dataFiles=[
        "orig/stop_obs.csv",
        "orig/stop_obs_up.csv",
        "orig/stop_obs_down.csv",
        "orig/stop_exp.csv",
        "orig/stop_exp_up.csv",
        "orig/stop_exp_down.csv",
        "orig/stop_xSecUpperLimit_obs.csv",
        "orig/stop_xSecUpperLimit_exp.csv",
    ],
    dataFormats=["csv"] * 8,
    units=[None] * 6 + ["pb"] * 2,
)
...
T2ttoff_1.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-12/figaux_01b.png"
)
T2ttoff_1.dataUrl = (
    "https://www.hepdata.net/record/ins1793461?version=2&table=stop_xSecUpperLimit_obs"
)
T2ttoff_1.setSources(
    dataLabels=[
        "obsExclusion",
        "obsExclusionP1",
        "obsExclusionM1",
    ...
    dataFiles=[
        "orig/stopoff_obs.csv",
        "orig/stopoff_obs_up.csv",
        "orig/stopoff_obs_down.csv",
        "orig/stopoff_exp.csv",
        "orig/stopoff_exp_up.csv",
        "orig/stopoff_exp_down.csv",
        "orig/stop_xSecUpperLimit_obs.csv",
        "orig/stop_xSecUpperLimit_exp.csv",
    ],
    dataFormats=["csv"] * 8,
...
T2bbffff_1.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-12/figaux_01b.png"
)
T2bbffff_1.dataUrl = (
    "https://www.hepdata.net/record/ins1793461?version=2&table=stop_xSecUpperLimit_obs"
)
T2bbffff_1.setSources(
    dataLabels=[
        "obsExclusion",
        "obsExclusionP1",
        "obsExclusionM1",
