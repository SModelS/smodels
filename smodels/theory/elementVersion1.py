...
class Element(object):
    ...
    def __init__(self, info=None):
        ...
        self.weightList = [] # holding the different weights for all possible combinations of prompt and displaced decays
        self.weightLabels = [] # list of strings describing which of the BSM particles is long lived or decayed promptly or displaced
