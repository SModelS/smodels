...
T6bbHHM60 = T6bbHH.addMassPlane(2 * [[x, y, 60.0]])
T6bbHHM60.figure = "figaux_02d(acceptance) and figaux_06d (efficiency)"
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_02d.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
T6bbHHM60.addSource(
...
T6bbHHDM130 = T6bbHH.addMassPlane(2 * [[x, y, y - 130.0]])
T6bbHHDM130.figure = "figaux_02c(acceptance) and figaux_06c (efficiency)"
T6bbHHDM130.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_02c.png"
)
T6bbHHDM130.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=DM130_bestCombined_UpperLimit"
)
T6bbHHDM130.addSource(
    "obsExclusion", "orig/HEPData-ins1748602-v1-DM130_Obs.csv", unit=None, dataFormat="csv"
)
T6bbHHDM130.addSource(
    "efficiencyMap",
    ("orig/Efficiency_SRA_L_dm130.csv", "orig/Acceptance_SRA_L_dm130.csv"),
    unit="/10000",
    dataFormat="mcsv",
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_03b.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHDM130.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_03a.png"
)
T6bbHHDM130.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=DM130_bestCombined_UpperLimit"
)
...
T6bbHHDM130.addSource(
    "efficiencyMap",
    ("orig/Efficiency_SRA_M_dm130.csv", "orig/Acceptance_SRA_M_dm130.csv"),
    unit="/10000",
    dataFormat="mcsv",
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_03d.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHDM130.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_03c.png"
)
T6bbHHDM130.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=DM130_bestCombined_UpperLimit"
)
...
T6bbHHDM130.addSource(
    "efficiencyMap",
    ("orig/Efficiency_SRA_H_dm130.csv", "orig/Acceptance_SRA_H_dm130.csv"),
    unit="/10000",
    dataFormat="mcsv",
)
...
T6bbHHDM130.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/fig_08b.png"
)
T6bbHHDM130.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=DM130_bestCombined_UpperLimit"
)
...
T6bbHHM60.figure = "figaux_05b (acceptance) and figaux_9b (efficiency)"
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_05b.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_04b.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_04c.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_04d.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
...
T6bbHHM60.figureUrl = (
    "https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SUSY-2018-31/figaux_05a.png"
)
T6bbHHM60.dataUrl = (
    "https://www.hepdata.net/record/ins1748602?version=1&table=Efficiency_SRB and others"
)
