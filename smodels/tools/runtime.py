...
_drmax = 0.338 # maximum ratio (oUL - eUL)/(oUL + eUL) that we allow before capping or returning None ( depending on _cap_likelihoods), 0.338 corresponds to two sigmas
