...
slha_hover_information = {'m(gluino)': ['MASS', 1000021], 'm(suR)': ['MASS', 2000002], 'm_LSP': ['MASS', 1000022]} 
...
BR_hover_information = {'BR_gluino': 1000021, 'BR_suR': 2000002}
...
#chi2 -> shows the chi^2 value, if available (if not, the output is 'False').
...
plot_list = ['SModelS_status','r_max', 'chi2', 'Tx', 'Analysis', 'MT_max', 'MT_max_xsec', 'MT_total_xsec', 'MT_long_xsec', 'MT_asym_xsec']
